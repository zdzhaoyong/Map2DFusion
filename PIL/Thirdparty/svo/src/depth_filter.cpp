...
void DepthFilter::initializeSeeds(FramePtr frame)
{
    ...
    else
    {
        ...
        frame->last_published_ts_=new_features.size();
...
void DepthFilter::removeKeyframe(FramePtr frame)
{
  ...
  while(it!=seeds_.end())
  {
    ...
    {
      it->ftr->frame->last_published_ts_--;
      it = seeds_.erase(it);
