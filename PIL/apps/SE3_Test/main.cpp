...
bool TestMatrix()
{
    ...
    cout<<"#######################Testing log&exp .###################\n";
    //log
    cout<<"pi::ln()="<<se3_d.ln()<<endl;

    TooN::SE3<> toon_se3=se3_d;
    cout<<"TooN::ln()="<<toon_se3.ln()<<endl;

    Sophus::SE3 sophus_se3=toSophus(se3_zy);
    cout<<"Sophus.ln()="<<sophus_se3.log()<<endl;

    //exp
    cout<<"pi::exp()="<<pi::SE3<>::exp(se3_d.ln())<<endl;
    cout<<"Sophus.exp()="<<sophus_se3.exp(sophus_se3.log());
...
int main(int argc,char** argv)
{
    ...
    float zy[6]={0.00926229358,
        -0.00106311403,
        0.00271050516,
        -0.00445604976,
        0.00755351456,
        0.00742330682};
    cout<<"exp:"<<SE3f::exp(*(pi::Array_<float,6>*)zy)<<endl;
    return 0;
}
